...
const IdPage = ({ params }: { params: { id: string | number } }) => {
  ...
  const handleAddToCart = () => {
    console.log("Adding item to cart:", cartItem); // For debugging purposes
    // Implement logic to add item to cart (dispatch action, etc.)
  };

  return (
    <div className="flex flex-wrap gap-y-10 py-6 px-40 pt-[100px] lg:pt-[150px]">
      {id.length > 0 ? (
        id.map((products) => (
            ...
            <div>
              ...
              <div>
                ...
                <div className="mt-5 flex items-center gap-x-4">
                    <Button className="bg-black" onClick={handleAddToCart}>
